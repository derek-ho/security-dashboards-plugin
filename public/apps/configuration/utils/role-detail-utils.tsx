...
export async function getRoleDetail(http: HttpStart, roleName: string, query?: HttpFetchQuery): Promise<RoleDetail> {
  return await httpGet<RoleDetail>({ http, url: getResourceUrl(API_ENDPOINT_ROLES, roleName), query });
}
